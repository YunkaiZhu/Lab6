...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (returnPokemon.getAttackLevel() < 1 || returnPokemon.getAttackLevel() > MAX_HIT_POINTS - 1) {
            System.out.println("Sorry. The attack level must be between 1 and 49: ");
            returnPokemon.setAttackLevel(myScan.nextInt());
        }
        System.out.println("Enter your defense level (1-" + (MAX_HIT_POINTS - returnPokemon.getAttackLevel()) + "):");
        ...
        while (returnPokemon.getDefenseLevel() < 1 || returnPokemon.getDefenseLevel() > MAX_HIT_POINTS  - returnPokemon.getAttackLevel()) {
            System.out.println("Sorry. The defense level must be between 1 and " + (MAX_HIT_POINTS - returnPokemon.getAttackLevel()) + ": ");
            returnPokemon.setDefenseLevel(myScan.nextInt());
        }
